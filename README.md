...
<p align="justify" style="max-width:800px; margin:auto; line-height:1.7;">
Soy un <strong>ingeniero y emprendedor</strong> apasionado por crear soluciones tecnológicas innovadoras.  
Actualmente desarrollo <strong>Caffesory</strong>, una app tipo <em>Vivino para café de especialidad</em> que combina 
visión computacional, machine learning y experiencias sensoriales interactivas.  
Mi enfoque está en el desarrollo de productos <strong>impactantes, escalables y centrados en el usuario</strong>.
</p>

<br/>

<h2 style="color:#58a6ff;">Áreas de Especialización</h2>

<ul style="list-style:none; text-align:left; display:inline-block; padding:0; line-height:1.8;">
  <li>Inteligencia Artificial y Machine Learning</li>
  <li>Desarrollo Full-Stack (FastAPI + React Native / Next.js)</li>
  <li>DevOps y Cloud (Docker, GCP, Firebase)</li>
  <li>Diseño UX/UI con enfoque en engagement y retención</li>
  <li>Marketing Digital y Estrategia de Crecimiento</li>
</ul>
